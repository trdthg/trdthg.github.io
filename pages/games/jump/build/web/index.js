...
var ASM_CONSTS = {
  91790: () => { if (document.fullscreenElement) return 1; },  
 91836: () => { return Module.canvas.width; },  
 91868: () => { return parseInt(Module.canvas.style.width); },  
 91916: () => { document.exitFullscreen(); },  
 91943: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 92015: () => { if (document.fullscreenElement) return 1; },  
 92061: () => { return Module.canvas.width; },  
 92093: () => { return screen.width; },  
 92118: () => { document.exitFullscreen(); },  
 92145: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 92339: () => { return window.innerWidth; },  
 92365: () => { return window.innerHeight; },  
 92392: () => { if (document.fullscreenElement) return 1; },  
 92438: () => { return Module.canvas.width; },  
 92470: () => { return parseInt(Module.canvas.style.width); },  
 92518: () => { if (document.fullscreenElement) return 1; },  
 92564: () => { return Module.canvas.width; },  
 92596: () => { return screen.width; },  
 92621: () => { return window.innerWidth; },  
 92647: () => { return window.innerHeight; },  
 92674: () => { if (document.fullscreenElement) return 1; },  
 92720: () => { return Module.canvas.width; },  
 92752: () => { return screen.width; },  
 92777: () => { document.exitFullscreen(); },  
 92804: () => { if (document.fullscreenElement) return 1; },  
 92850: () => { return Module.canvas.width; },  
 92882: () => { return parseInt(Module.canvas.style.width); },  
 92930: () => { document.exitFullscreen(); },  
 92957: ($0) => { Module.canvas.style.opacity = $0; },  
 92995: () => { return screen.width; },  
 93020: () => { return screen.height; },  
 93046: () => { return window.screenX; },  
 93073: () => { return window.screenY; },  
 93100: () => { return window.devicePixelRatio; },  
 93136: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 93189: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93240: () => { Module.canvas.style.cursor = 'none'; },  
 93277: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 93533: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 93584: () => { if (document.pointerLockElement) return 1; },  
 93631: () => { if (document.fullscreenElement) return 1; },  
