import{d as n}from"./app.23e7f017.js";import{_ as s}from"./plugin-vue_export-helper.21dcd24c.js";const a={},p=n(`<h1 id="\u5B9E\u73B0\u4E00\u4E2Amini-bundle" tabindex="-1"><a class="header-anchor" href="#\u5B9E\u73B0\u4E00\u4E2Amini-bundle" aria-hidden="true">#</a> \u5B9E\u73B0\u4E00\u4E2Amini-bundle</h1><div class="language-javascript ext-js line-numbers-mode"><pre class="language-javascript"><code><span class="token keyword">const</span> fs <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">&#39;fs&#39;</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
...
<span class="token comment">// \u6839\u636E\u6587\u4EF6\u540D\uFF0C\u62FF\u5230\u8BE5\u6587\u4EF6\u7684\u4FE1\u606F\uFF0C\u5305\u62ECid\uFF0Ccode(\u8F6C\u6362\u540E\u7684), requirements</span>
<span class="token keyword">function</span> <span class="token function">createAsset</span><span class="token punctuation">(</span><span class="token parameter">filename</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// \u901A\u8FC7fs\u5F15\u5165\u5165\u53E3\u6587\u4EF6</span>
    ...
    <span class="token comment">// \u62FF\u5230\u6240\u6709\u7684import\u4F9D\u8D56</span>
    ...
    <span class="token keyword">const</span> code <span class="token operator">=</span> babel<span class="token punctuation">.</span><span class="token function">transformFromAst</span><span class="token punctuation">(</span>ast<span class="token punctuation">,</span> <span class="token keyword">null</span><span class="token punctuation">,</span> <span class="token punctuation">{</span>
        <span class="token comment">// presets\u544A\u8BC9babel\u8F6C\u6362\u7684\u65B9\u6CD5</span>
        <span class="token comment">// env\u6307 babel-preset-env\u63D2\u4EF6\uFF0C\u786E\u4FDD\u8F6C\u6362\u7684\u4EE3\u7801\u80FD\u591F\u5728\u6240\u6709\u6D4F\u89C8\u5668\u4E0A\u8FD0\u884C</span>
...
<span class="token comment">// \u521B\u5EFA\u4E00\u4E2AArray\uFF0C\u91CC\u9762\u662F\u6240\u6709\u7684\u4F9D\u8D56\uFF0C\u6BCF\u4E00\u4E2ANode\u7528mapping\u4FDD\u5B58\u4F9D\u8D56\u4E4B\u95F4\u7684\u5173\u7CFB</span>
<span class="token keyword">function</span> <span class="token function">createGraph</span><span class="token punctuation">(</span><span class="token parameter">entry</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">const</span> asset <span class="token keyword">of</span> queue<span class="token punctuation">)</span> <span class="token punctuation">{</span>
        ...
        asset<span class="token punctuation">.</span>dependencies<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">relativePath</span> <span class="token operator">=&gt;</span> <span class="token punctuation">{</span>
            ...
            <span class="token comment">// \u6BCF\u4E2ANode\u7528\u4E00\u4E2Amap\u5B58\u50A8\u4ED6\u4F9D\u8D56\u7684\u5BF9\u8C61</span>
...
<span class="token keyword">function</span> <span class="token function">bundle</span><span class="token punctuation">(</span><span class="token parameter">graph</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    <span class="token comment">// \u53C2\u6570\u6574\u4F53\u662F\u4E00\u4E2AObject\uFF0C\u4E0B\u9762\u62FC\u63A5\u4E86Object\u91CC\u7684\u6240\u6709\u952E\u503C\u5BF9\uFF0C\u5982\u4E0B\uFF1A</span>
    <span class="token comment">// id: [code, mapping]</span>
    <span class="token comment">// code\u6700\u5916\u5C42\u8FD8\u5957\u4E0A\u4E86\u4E00\u4E2Afunction</span>
...
<span class="token keyword">const</span> graph <span class="token operator">=</span> <span class="token function">createGraph</span><span class="token punctuation">(</span><span class="token string">&#39;./example/entry.js&#39;</span><span class="token punctuation">)</span>
